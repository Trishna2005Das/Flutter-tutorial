...
class _CurrencyState extends State<Currency> {
  //State makes this class mutable as widgets are immutable so theres no performance impact on the widget
  double result = 0;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              //appears like a text
              // Container( //container does not have a constant constructor so it is rebuilt 
              //   height: 10,
              // ),
              TextButton(
                //returns void
